    ...
    <div id="pdf-container" style="display: none;">
        <div id="pdf-template"
            ...
            <div
                ...
                <div>
                    <h1
                        style="color: #1a1a1a; font-size: 24px; font-weight: 700; margin: 0 0 8px 0; display: flex; align-items: center; gap: 8px;">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FBAF03" stroke-width="3"
                            stroke-linejoin="round" stroke-linecap="round">
                            <path d="M12 2L2 22h20L12 2z" />
                            <path d="M12 22L12 12" stroke="#1a1a1a" />
                        </svg>
            ...
            <!-- Footer Note -->
            <p
                style="color: #b0b0b0; font-size: 11px; line-height: 1.5; border-top: 1px solid #e0e0e0; padding-top: 20px; page-break-inside: avoid;">
                This report was generated by the Sheet Metal Bend Allowance Calculator at
                teslamechanicaldesigns.com.<br>
                Calculations are for reference only. Always verify with your CAD system and material data sheets.<br>
